      ...
      <div className="relative z-10 w-full max-w-md bg-card/85 backdrop-blur-md border border-border/60 shadow-card rounded-2xl p-8 space-y-6">
        ...
        <div className="space-y-2.5">
          <button
            ...
            className="w-full h-10 bg-secondary hover:bg-border/60 border border-border/80 text-foreground font-bold rounded-xl text-xs transition-all flex items-center justify-center gap-1.5"
          >
