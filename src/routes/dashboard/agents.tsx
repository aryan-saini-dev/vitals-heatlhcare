...
export default function Agents() {
  ...
  const isExact = location.pathname === "/dashboard/agents" || location.pathname === "/dashboard/agents/";
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b border-border/40 pb-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground font-medium">
            Configure specialized conversational monitors to automatically check in with chronic patients.
          </p>
        </div>
        <Link
