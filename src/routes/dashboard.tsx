      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-border/60 bg-card z-20 shrink-0">
        ...
        <div className="p-4 border-t border-border/50">
          <button
            ...
            className="flex items-center justify-center gap-2.5 w-full py-2.5 px-4 font-semibold rounded-xl text-muted-foreground hover:bg-secondary hover:text-destructive border border-border/50 hover:border-destructive/20 transition-all text-sm"
          >
