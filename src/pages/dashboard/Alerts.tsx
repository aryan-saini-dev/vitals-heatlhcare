...
import { Bell, CheckCircle2, FileText, Check, X, Download } from "lucide-react";
                ...
                <div className="flex flex-col gap-4 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Patient:{" "}
                      <Link
                        to={`/dashboard/patients/${alert.patient_id}`}
                        ...
                        {alert.call && (
                          <>
                            ...
                            <Link
                              ...
                              className="inline-flex items-center gap-1.5 h-9 px-3.5 bg-primary/10 hover:bg-primary hover:text-primary-foreground border border-primary/20 rounded-xl font-semibold text-xs text-primary transition-all cursor-pointer"
                            >
