                  ...
                  <tr key={patient.id} className="hover:bg-secondary/20 transition-colors group">
                    ...
                    <td className="p-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 px-3.5 py-1.5 bg-secondary text-foreground hover:bg-primary hover:text-primary-foreground rounded-lg font-bold text-xs border border-border/80 hover:border-transparent transition-all cursor-pointer"
                      >
