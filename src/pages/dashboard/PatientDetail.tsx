...
import { ArrowLeft, Activity, Phone, AlertTriangle, Calendar, Brain } from "lucide-react";
            ...
            <div className="space-y-3">
              {calls.map((c) => (
                <Link
                  ...
                  key={c.id}
                  className="block p-4 border border-border/60 rounded-xl bg-background hover:border-primary/30 transition-all group cursor-pointer"
                >
